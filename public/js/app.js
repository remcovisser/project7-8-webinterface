        ...
        var timer = function () {
            ...
            $.get(api_url, function (data) {
                for (var i = 0; i < data.length; i++) {
                    var location_1 = data[i];
                    // Create Icon object for a marker
                    var icon = {
                        url: "http://icons.iconarchive.com/icons/iconsmind/outline/512/Shopping-Cart-icon.png",
...
Component.options.__file = "/Users/remcovisser/code/werk/project7-8-webinterface/resources/assets/js/components/Example.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-64d411ee", Component.options)
  } else {
    hotAPI.reload("data-v-64d411ee", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-64d411ee", module.exports)
  }
}
